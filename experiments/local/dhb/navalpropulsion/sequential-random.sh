...
export pruning_strategies=("CONST4")
# export pruning_strategies=("LOGLIN2" "ULOGLIN2")
# export pruning_strategies=("CONST1" "CONST2" "CONST4" "CONST8")
# export pruning_strategies=("CONST4" "CONST8")
# export pruning_strategies=("NONE" "SHA" "MED" "ULOGLIN2" "LOGLIN3" "ULOGLIN3") # "LOGLIN4" "ULOGLIN4")
